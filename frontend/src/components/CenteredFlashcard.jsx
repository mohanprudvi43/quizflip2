...
const CenteredFlashcard = ({ card, flipped, onFlip, cardIndex, totalCards, onTouchStart, onTouchEnd, onSwipe }) => {
  ...
  const keyPoints = card.key_points || card.keyPoints || [];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flip-face back absolute inset-0 p-8 md:p-10">
