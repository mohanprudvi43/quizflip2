...
Fig 5.9 ER Diagram - Database Model  
...
#### 5.7.0 ER Diagram - Database Model

The ER diagram below shows key entities with primary keys and core one-to-many relationships used in quiz data flow.

1. USER with `user_id` as primary key.
2. QUIZ with `quiz_id` as primary key.
3. QUESTION with `question_id` as primary key.
4. One user can attempt many quizzes (1:M).
5. One quiz can contain many questions (1:M).

**Fig 5.9 ER Diagram - Database Model**

<div align="center" style="background:#ffffff; padding:12px; border:1px solid #d1d5db; border-radius:10px;">
	<img src="diagrams/generated/fig5_9_er.png" alt="Fig 5.9 ER Diagram - Database Model" style="max-width:100%; height:auto;" />
</div>
