# QUIZFLIP REPORT (FINAL SUBMISSION VERSION)

This version includes style markers for direct Word formatting.

Word formatting checklist:
1. Body text: Times New Roman, 12pt, justified, 1.5 line spacing
2. Margins: Left 1.5 inch, Right 1 inch, Top 1 inch, Bottom 1 inch
3. Apply each [STYLE: ...] marker, then delete marker lines
4. Keep [PAGE BREAK] only as Word manual page breaks
5. Start page numbering from Chapter 1 Introduction
6. Keep figure and table numbering chapter-wise
...
[STYLE: Chapter Label | Left | Bold | 16pt]
[PAGE BREAK]
## CHAPTER 1
[STYLE: Chapter Title | Center | Bold | 18pt | ALL CAPS]
# INTRODUCTION

[STYLE: Section Heading | Left | Bold | 16pt]
### 1.1 Background and Motivation
...
[STYLE: Subsection Heading | Left | 14pt]
